  ...
  return (
    <div className="bg-[#243949] min-h-screen pt-32 px-10">
      <div className="max-w-screen-2xl mx-auto">
        <h1 className="heading-serif text-6xl">Сайн байна уу, [Нэр]</h1>
        ...
        <div className="mt-20 grid md:grid-cols-12 gap-12">
          ...
          <div className="md:col-span-3">
            <div className="space-y-6 text-sm tracking-widest">
              ...
              <a href="#" className="block">Дахин ирэх мэдэгдэл</a>
              <a href="#" className="block">1:1 Лавлагаа</a>
              <a href="#" className="block">Мэдээлэл засах</a>
              <a href="#" className="block text-red-400">Гишүүнчлэлээс гарах</a>
            </div>
          </div>
