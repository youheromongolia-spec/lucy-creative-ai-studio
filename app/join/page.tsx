        ...
        <div className="max-w-md w-full bg-[#FDFCF8] text-[#172019] p-16">
          ...
          <form className="space-y-8">
            <div>
              ...
              <input id="name" type="text" title="Нэр" placeholder="Таны нэр" className="w-full border-b border-[#172019]/30 pb-4 focus:outline-none focus:border-[#4A5D4E]" />
            </div>
            <div>
            ...
            <div>
              <label htmlFor="confirm-password" className="block text-xs tracking-widest mb-2">НУУЦ ҮГ ДАВТАХ</label>
              <input id="confirm-password" type="password" title="Нууц үг давтах" placeholder="Нууц үгийг давтан оруулах" className="w-full border-b border-[#172019]/30 pb-4 focus:outline-none focus:border-[#4A5D4E]" />
            </div>
          ...
          <div className="text-center mt-12 text-sm">
            <a href="/login" className="text-[#4A5D4E] hover:underline">Бүртгэлтэй юу? Нэвтрэх</a>
          </div>
        </div>
      </PatternOverlay>
    </div>
